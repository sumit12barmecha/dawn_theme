...
var shopAllLine = document.querySelector('.shopAllLine')
    if (desktopDiv && mobileDiv) {
      ...
      if (shopAllLine) {
        ...
        shopAllLine.style.marginBottom = '0.75rem'; // mb-3 in Tailwind equals 0.75rem
        shopAllLine.style.width = '80%'; // w-4/5 in Tailwind equals 80%
      }
    }
  }
